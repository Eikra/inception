...
mysql  -e "CREATE USER '$WP_USR'@'$MYSQL_HOSTNAME' IDENTIFIED BY '$WP_PWD';"
# mysql  -e "GRANT ALL PRIVILEGES ON $MYSQL_DATABASE.* TO '$WP_USR'@'$MYSQL_HOSTNAME';"
mysql -e " GRANT ALL PRIVILEGES ON $MYSQL_DATABASE.* TO '$WP_USR'@'%' IDENTIFIED BY '$WP_PWD';"
